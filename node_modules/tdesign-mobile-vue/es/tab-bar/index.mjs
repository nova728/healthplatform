...
import _TabBar from './tab-bar.mjs';
import _TabBarItem from './tab-bar-item.mjs';
...
import './useTabBar.mjs';
import './tab-bar-item-props.mjs';
...
export { TabBar, TabBarItem, TabBar as default };
